...
#         return self.asosiy_narx.oylik_tolov()
#
#     def tavsif(self):
...
#         Har bit qo'shimcha ekran uchun 20% qo'shimcha to'lov
#         """
#
#         baza = super().oylik_tolov()
...
#     """Polimorfiza: har bir obuna turining o'z oylik to'lov() metodi chaqiriladi"""
#     jami = 0
